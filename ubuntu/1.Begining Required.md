...
Go to Open Bangla Keyboard Website or Avro omiron lab website then install any keyboard. Then go to setting and add keyboard input method Open Bangla Keyboard for bangla suupport, now can possible to write bangla ```super key+space bar```.